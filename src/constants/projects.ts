...
export const projects: Project[] = [
  {
    slug: "polaris-web-studio",
    title: "Polaris Web Studio",
    cinemaColor: "#6366f1",
    client: "Proyecto Propio",
    clientEN: "In-House Project",
    isConcept: false,
    plan: "Nova",
    planEN: "Nova",
    type: "Agencia · Sitio + Portal de Clientes",
    typeEN: "Agency · Site + Client Portal",
    liveUrl: "https://polarisweb.studio/",
    ...
    // colgado esperando "fonts to load" indefinidamente incluso
    // abortando/vaciando las peticiones a Google Fonts; CDP evita ese
    // chequeo interno de Playwright por completo.
    desktopImg: "https://storage.googleapis.com/gen-lang-client-0746441136.firebasestorage.app/Polaris/PolarisPoster-v1.jpg",
    previewVideo: "https://storage.googleapis.com/gen-lang-client-0746441136.firebasestorage.app/Polaris/PolarisPreview-v1.mp4",
    previewPoster: "https://storage.googleapis.com/gen-lang-client-0746441136.firebasestorage.app/Polaris/PolarisPoster-v1.jpg",
    mobileImg: "https://storage.googleapis.com/gen-lang-client-0746441136.firebasestorage.app/Polaris/PolarisMobilePoster-v1.jpg",
    mobileVideo: "https://storage.googleapis.com/gen-lang-client-0746441136.firebasestorage.app/Polaris/PolarisMobilePreview-v1.mp4",
    mobilePoster: "https://storage.googleapis.com/gen-lang-client-0746441136.firebasestorage.app/Polaris/PolarisMobilePoster-v1.jpg",
    shortDesc:
      "El propio sitio y portal de Polaris Web Studio: cotizador con precios en vivo, propuestas y contratos con firma electrónica, y un portal de cliente real con facturación, tareas y reuniones.",
    shortDescEN:
      "Polaris Web Studio's own site and portal: live-pricing quote wizard, proposals and contracts with electronic signature, and a real client portal with billing, tasks and meetings.",
    keyResult: "Autogestión",
    keyResultEN: "Self-Service",
    resultLabel: "Ciclo Comercial Completo",
    resultLabelEN: "Full Sales Cycle",
    color: "from-indigo-500/20 to-transparent",
    size: "large",
    icon: Zap,
    context:
      "Polaris Web Studio es la propia agencia: además del sitio de marketing bilingüe, corre un cotizador con precio de dominio en vivo, envío de propuestas comerciales, contratos con firma electrónica simple, y un portal donde cada cliente ve sus tareas, facturas y reuniones reales.",
    contextEN:
      "Polaris Web Studio is the agency itself: alongside the bilingual marketing site, it runs a quote wizard with live domain pricing, commercial proposal delivery, contracts with simple electronic signature, and a portal where each client sees their real tasks, invoices and meetings.",
    challenge:
      "Que todo el ciclo comercial -- cotizar, proponer, firmar, cobrar y entregar -- funcione sin que el cliente tenga que escribir un correo para cada paso.",
    challengeEN:
      "Making the entire sales cycle -- quoting, proposing, signing, billing and delivering -- work without the client needing to send an email at every step.",
    solution:
      "Un cotizador que calcula el precio real (incluyendo dominio), correos automáticos bilingües en cada etapa, y un portal de cliente para dar seguimiento sin depender de WhatsApp o correo.",
    solutionEN:
      "A quote wizard that computes the real price (including the domain), automated bilingual emails at every stage, and a client portal to follow along without relying on WhatsApp or email.",
    results: [
      {
        label: "Cotización",
        labelEN: "Quoting",
        value: "Precio en Vivo",
        valueEN: "Live Pricing",
      },
      {
        label: "Contrato",
        labelEN: "Contract",
        value: "Firma Electrónica",
        valueEN: "E-Signature",
      },
      {
        label: "Portal",
        ...
        valueEN: "Self-Service",
      },
    ],
    techStack: ["React", "TypeScript", "Tailwind CSS", "Firebase", "Express"],
  },
  {
