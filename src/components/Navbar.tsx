...
export default function Navbar({ variant = "default" }: NavbarProps) {
  ...
  return (
    <>
      ...
      >
        <div className={isImmersive ? "w-full" : isEditorial ? "mx-auto max-w-[1200px] px-4 pt-5 md:px-6" : "max-w-7xl mx-auto px-4 md:px-10 pt-3"}>
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              <div className={`${isImmersive ? "w-full px-4 md:px-12 mt-0" : isEditorial ? "mx-auto max-w-[1200px] px-4 md:px-6 mt-2" : "max-w-7xl mx-auto px-4 md:px-10 mt-2"} grid grid-cols-2 sm:grid-cols-3 gap-2 overscroll-contain pb-2 mobile-menu-grid`}>
                {cards.map((card, i) => (
                  <motion.div
                    key={i}
