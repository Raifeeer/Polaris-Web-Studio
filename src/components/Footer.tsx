...
export default function Footer({
  ...
  return (
    <footer className={`w-full border-t border-[var(--color-border-subtle)] px-6 py-16 md:px-12 ${variant === "mercury" ? "mercury-footer bg-[#171721]" : variant === "editorial" ? "twilight-footer bg-[#f7f7f7]" : variant === "immersive" ? "bg-[var(--color-surface-elevated)]" : "glass-panel"}`}>
      ...
      {variant !== "editorial" && variant !== "mercury" && (
