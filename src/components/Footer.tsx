      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-3 text-sm text-[var(--color-text-secondary)]">
            ...
            <Link to="/servicios" className="hover:text-[var(--color-primary-base)] transition-colors"><T en="Services">Servicios</T></Link>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-3 text-sm text-[var(--color-text-secondary)]">
            ...
            <Link to="/servicios" className="hover:text-[var(--color-primary-base)] transition-colors"><T en="Corporate Apps">Apps Corporativas</T></Link>
            <Link to="/servicios" className="hover:text-[var(--color-primary-base)] transition-colors"><T en="SEO Optimization">Optimización SEO</T></Link>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-3 text-sm text-[var(--color-text-secondary)] items-start">
            ...
            <p className="leading-relaxed text-left">
              <T en={<>100% Remote Operation.<br />Available Worldwide.</>}>
                Operación 100% Remota.<br />Disponibles para todo el mundo.
              </T>
            </p>
          </div>
        </div>
