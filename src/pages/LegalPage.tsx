  ...
  return (
    <div className="space-y-10">
      ...
      <Section heading={<T en="4. Who we share data with">4. Con quién compartimos tus datos</T>}>
        ...
        <SubHeading><T en="Google Business Profile and third-party accounts">Google Business Profile y cuentas de terceros</T></SubHeading>
        <p>
          <T en="Local Lift does not require you to connect your Google Business Profile account and does not request passwords, administrator access, or write permissions. We prepare the recommendations, text, images and guides; you decide whether and when to apply them in your own account.">
            Local Lift no requiere que conectes tu cuenta de Google Business Profile ni solicita
            contraseñas, acceso de administrador o permisos de escritura. Preparamos las
            recomendaciones, textos, imágenes y guías; tú decides si los aplicas y cuándo hacerlo
            en tu propia cuenta.
          </T>
        </p>
        <p>
          <T en="We may use publicly available business information and information you provide to prepare the purchased service. Google Business Profile and other third-party platforms have their own rules, permissions and availability, which remain your responsibility when you apply the recommendations.">
            Podemos utilizar información pública del negocio y la información que nos proporciones
            para preparar el servicio adquirido. Google Business Profile y las demás plataformas
            de terceros tienen sus propias reglas, permisos y disponibilidad, que siguen bajo tu
            responsabilidad cuando aplicas las recomendaciones.
          </T>
        </p>
        <p>
          <T en="No Google Business Profile connection or access token is stored by Local Lift. If you later choose to apply any recommendation, you do so directly in your own account.">
            Local Lift no almacena conexiones ni tokens de acceso de Google Business Profile. Si
            posteriormente decides aplicar alguna recomendación, lo haces directamente en tu propia
            cuenta.
          </T>
        </p>
      </Section>
