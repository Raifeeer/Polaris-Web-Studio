...
export default function LandingPage() {
  ...
  useEffect(() => {
    const metaData: Record<string, { esTitle: string; esDesc: string; enTitle: string; enDesc: string }> = {
      inicio: {
        esTitle: "Polaris Web Studio | Diseño y Desarrollo de Páginas Web Premium",
        esDesc: "Desarrollamos sitios web, landing pages y e-commerce de alto impacto y velocidad máxima, diseñados para captar clientes y potenciar tu negocio.",
        enTitle: "Polaris Web Studio | Premium Web Design & Development",
        enDesc: "We build high-impact, ultra-fast websites, landing pages, and e-commerces designed to acquire customers and scale your business."
      },
      servicios: {
        esTitle: "Nuestros Servicios Web | Landing Pages, E-commerce y Corporativas",
        esDesc: "Soluciones web de software original optimizados para conversión. Creamos tiendas virtuales, webs elegantes y landing pages eficaces.",
        enTitle: "Our Web Services | Landing Pages, E-commerce & Corporate Websites",
        enDesc: "Custom web software optimized for conversion. We build online stores, elegant corporate sites, and high-converting landing pages."
      },
      proceso: {
        esTitle: "Nuestro Proceso de Desarrollo | Ágil y Transparente",
        esDesc: "Conoce los 3 sencillos pasos que transformarán tu visión en una realidad digital de alto rendimiento: Cotiza, Diseñamos y Lanzamos.",
        enTitle: "Our Web Development Process | Agile & Transparent",
        enDesc: "Learn the 3 simple steps to transform your vision into high-performance digital reality: Quote, Design, and Launch."
      },
      portafolio: {
        esTitle: "Nuestro Portafolio de Proyectos Web | Casos de Éxito",
        esDesc: "Explora proyectos reales impecablemente optimizados: Lúmina Sky, Nexus Realty, y Chroma Tech Store construidos en código limpio.",
        enTitle: "Our Web Projects Portfolio | Live Demos & Success Cases",
        enDesc: "Explore high-fidelity, real-world custom projects: Lumina Sky, Nexus Realty, and Chroma Tech Store meticulously engineered."
      },
      faq: {
        esTitle: "Preguntas Frecuentes | Soporte y Tarifas Web",
        esDesc: "Dudas resueltas sobre tiempos de entrega, hosting, mantenimiento SEO, facilidades de pago y cotizaciones desde $299 USD.",
        enTitle: "Frequently Asked Questions | Web Pricing & Support FAQs",
        enDesc: "Get answers regarding turnaround times, hosting, SEO maintenance, flexible payment plans, and custom estimates starting at $299 USD."
      },
      contacto: {
        esTitle: "Hablemos de tu Proyecto | Cotizador Web Inteligente",
        esDesc: "Obtén tu propuesta gratuita en minutos con nuestro cotizador interactivo. Sin compromisos ni costes ocultos y agenda inmediata.",
        enTitle: "Let's Build Your Project | Smart Interactive Web Quote",
        enDesc: "Complete our dynamic quote tool in under 2 minutes and unlock detailed deliverables, rates, and launch schedules."
      }
    };

    const currentMeta = metaData[activeSection] || metaData.inicio;
    const currentTitle = language === 'es' ? currentMeta.esTitle : currentMeta.enTitle;
    const currentDesc = language === 'es' ? currentMeta.esDesc : currentMeta.enDesc;
  ...
  useEffect(() => {
    ...
    const sections = ['inicio', 'servicios', 'proceso', 'portafolio', 'faq', 'contacto'];
    sections.forEach((id) => {
  ...
  const featuredProjects = [
    {
      ...
      desc: <T en="Luxury boutique hotel prototype with a custom booking engine and fine-tuned interactive animations.">Prototipo de hotel boutique de lujo con motor de reservas y animaciones fluidas de alta fidelidad.</T>,
      stack: ["React", "Framer Motion", "Vite", "Tailwind CSS"],
      metrics: [
        { label: <T en="Google PageSpeed">Google PageSpeed</T>, value: "99/100" },
        { label: <T en="Load Time">Carga Inicial</T>, value: "0.4s" },
        { label: <T en="Engagement">Interactividad</T>, value: <T en="Excellent">Excelente</T> }
      ],
    ...
    },
    {
      ...
      desc: <T en="Real estate platform catalog showing rapid, zero-lag filters to browse elite properties on mobile.">Catálogo inmobiliario interactivo optimizado para un filtrado ultra-rápido de propiedades de lujo.</T>,
      stack: ["React", "TypeScript", "Tailwind CSS"],
      metrics: [
        { label: <T en="Search Engine">Buscador Inteligente</T>, value: <T en="Instant">Instantáneo</T> },
    ...
    },
    {
      ...
      desc: <T en="High-performance automated digital store prototype with smart cart, AI assistant and secure gateway.">Tienda online de tecnología con pasarela de pago, buscador inteligente con IA y carrito persistente.</T>,
      stack: ["Next.js", "Zustand", "Stripe (UI)", "Tailwind CSS"],
      metrics: [
        { label: <T en="Payment Flow">Trámite Pago</T>, value: <T en="100% Secure">100% Seguro</T> },
        { label: <T en="Uptime">Uptime</T>, value: "24/7/365" },
        { label: <T en="AI Assistant">Asistente de IA</T>, value: <T en="Integrated">Integrado</T> }
      ],
      colorClass: "from-violet-500/20 to-fuchsia-500/5 hover:border-violet-500/40"
    }
  ];

  const faqs = [
    { q: <T en="How much does a project cost?">¿Cuánto cuesta un proyecto?</T>, a: <T en="Our custom professional projects start from $299 USD. We offer clear pricing with zero hidden costs, structured based on your specific requirements and complexity.">Nuestros proyectos profesionales y personalizados comienzan desde $299 USD. Ofrecemos precios claros sin sorpresas ni costos ocultos, adaptados a la complejidad y necesidades específicas de tu negocio.</T> },
    ...
    <div className="min-h-screen flex flex-col bg-[var(--color-surface-base)] relative overflow-hidden">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 md:px-10 py-4 md:py-20 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 auto-rows-min">
              ...
              <div className="pt-2">
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 md:gap-6">
                  ...
                  >
                    ...
                    <Rocket size={20} className="group-hover:rotate-12 group-hover:-translate-y-1 transition-transform duration-300" />
                    
                    <T en="Get a Quote">Cotizar Proyecto</T>
                    
                    <ArrowRight size={20} className="ml-1 group-hover:translate-x-2 transition-transform duration-300" />
                  </button>
                  <div className="flex flex-col text-left space-y-0.5">
                    ...
                    <span className="text-[10px] sm:text-xs text-[var(--color-text-secondary)] font-medium">
                      <T en="Agile delivery · Fully customized coding">Entrega ágil · Código 100% original</T>
                    </span>
                  </div>
                </div>
              </div>
            ...
            <Link to="/servicios" className="flex flex-col p-6 sm:p-8 h-full items-start gap-4 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[var(--color-primary-base)]/50 rounded-[var(--radius-bento)] text-left justify-between w-full">
              ...
              <div className="border-t border-[var(--color-border-subtle)]/40 pt-4 mt-6 w-full space-y-2">
                <div className="flex items-center gap-2 text-[11px] text-[var(--color-text-secondary)]">
                  ...
                  <span><T en="Lead capture funnel">Captura rápida de leads</T></span>
                </div>
                <div className="flex items-center gap-2 text-[11px] text-[var(--color-text-secondary)]">
                  <CheckCircle2 size={13} className="text-indigo-400 shrink-0" />
                  <span><T en="100% responsive layout">Diseño móvil optimizado</T></span>
                </div>
                <div className="flex items-center gap-2 text-[11px] text-[var(--color-text-secondary)]">
                  <CheckCircle2 size={13} className="text-indigo-400 shrink-0" />
                  <span><T en="WhatsApp integrated button">WhatsApp directo integrado</T></span>
                </div>
              </div>
            </Link>
          </motion.div>
            ...
            <Link to="/servicios" className="flex flex-col p-6 sm:p-8 h-full items-start gap-4 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[var(--color-primary-base)]/50 rounded-[var(--radius-bento)] text-left justify-between w-full">
              ...
              <div className="border-t border-[var(--color-border-subtle)]/40 pt-4 mt-6 w-full space-y-2">
                <div className="flex items-center gap-2 text-[11px] text-[var(--color-text-secondary)]">
                  ...
                  <span><T en="Stripe & payment systems">Pasarela segura de pago</T></span>
                </div>
                <div className="flex items-center gap-2 text-[11px] text-[var(--color-text-secondary)]">
                  <CheckCircle2 size={13} className="text-emerald-400 shrink-0" />
                  <span><T en="Intuitive product manager">Administrador de productos</T></span>
                </div>
                <div className="flex items-center gap-2 text-[11px] text-[var(--color-text-secondary)]">
                  <CheckCircle2 size={13} className="text-emerald-400 shrink-0" />
                  <span><T en="Frictionless checkouts">Experiencia de compra ágil</T></span>
                </div>
              </div>
            </Link>
          </motion.div>
            ...
            <Link to="/servicios" className="flex flex-col p-6 sm:p-8 h-full items-start gap-4 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[var(--color-primary-base)]/50 rounded-[var(--radius-bento)] text-left justify-between w-full">
              ...
              <div className="border-t border-[var(--color-border-subtle)]/40 pt-4 mt-6 w-full space-y-2">
                <div className="flex items-center gap-2 text-[11px] text-[var(--color-text-secondary)]">
                  ...
                  <span><T en="Premium custom layout">Diseño estético premium</T></span>
                </div>
                <div className="flex items-center gap-2 text-[11px] text-[var(--color-text-secondary)]">
                  <CheckCircle2 size={13} className="text-violet-400 shrink-0" />
                  <span><T en="Self-manageable section & blog">Secciones y blog auto-editables</T></span>
                </div>
                <div className="flex items-center gap-2 text-[11px] text-[var(--color-text-secondary)]">
                  <CheckCircle2 size={13} className="text-violet-400 shrink-0" />
                  <span><T en="Enterprise light-speed loading">Velocidad y carga excelente</T></span>
                </div>
              </div>
            </Link>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="border-t border-[var(--color-border-subtle)]/40 pt-4 mt-5 space-y-2 text-left">
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    ...
                    <span><T en="Conversion optimized Landing Page">Landing Page optimizada a conversión</T></span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-blue-400 shrink-0" />
                    <span><T en="Domain setup & hosting">Dominio y alojamiento listo</T></span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-blue-400 shrink-0" />
                    <span><T en="Initial client capturing funnel">Sistemas de captación rápidos</T></span>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="mt-2.5 mb-4 border-l-2 border-amber-400/80 bg-amber-400/5 px-3 py-2 rounded-r-lg">
                      <p className="text-[11px] font-bold text-[var(--color-text-primary)] uppercase tracking-wide leading-tight">
                        <T en={'"Your business exists but your site doesn\'t sell"'}>"Tu negocio ya existe pero tu web no vende"</T>
                      </p>
                    </div>
                ...
                <div className="border-t border-[var(--color-border-subtle)]/40 pt-4 mt-5 space-y-2 text-left">
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    ...
                    <span><T en="Premium redesign & clean catalog">Rediseño estético y catálogo premium</T></span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-amber-400 shrink-0" />
                    <span><T en="CRM or WhatsApp integrations">Integración con CRM o WhatsApp</T></span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-amber-400 shrink-0" />
                    <span><T en="High-converting multi-page layout">Arquitectura multi-página robusta</T></span>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="mt-2.5 mb-4 border-l-2 border-emerald-400/80 bg-emerald-500/5 px-3 py-2 rounded-r-lg">
                      <p className="text-[11px] font-bold text-[var(--color-text-primary)] uppercase tracking-wide leading-tight">
                        <T en={'"You want to sell online"'}>"Quieres vender en línea"</T>
                      </p>
                    </div>
                ...
                <div className="border-t border-[var(--color-border-subtle)]/40 pt-4 mt-5 space-y-2 text-left">
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-emerald-400 shrink-0" />
                    <span><T en="Agile cart & frictionless checkout">Carrito ágil y checkout sin roces</T></span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-emerald-400 shrink-0" />
                    <span><T en="Stripe or custom payment gateways">Pasarela Stripe o métodos locales</T></span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-emerald-400 shrink-0" />
                    <span><T en="Self-manageable admin products center">Administrador de productos fácil</T></span>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          >
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <p className="text-[var(--color-text-secondary)] text-sm max-w-md mx-auto leading-relaxed">
                <T en="Three simple steps to transform your vision into a high-performance digital reality.">Tres pasos simples para transformar tu idea en una realidad digital de alto rendimiento.</T>
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
              ...
              >
                ...
                <div className="space-y-2 w-full">
                  <h3 className="text-xl font-display font-black tracking-tight text-[var(--color-text-primary)] group-hover:text-[var(--color-primary-base)] transition-colors">
                    <T en="Cotizas">Cotizas</T>
                  </h3>
                  <p className="text-xs text-[var(--color-text-secondary)] leading-relaxed">
                    <T en="Tell us about your project in our smart builder form and get a custom strategy estimation.">
                      Cuéntanos tu idea en nuestro cotizador dinámico y recibe una estimación y plan personalizado de inmediato.
                    </T>
                  </p>
                </div>
                ...
                <div className="w-full border-t border-[var(--color-border-subtle)]/40 pt-4 mt-1 space-y-2 text-left">
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    ...
                    <span><T en="Adaptive instant pricing">Presupuesto adaptado al instante</T></span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-emerald-500 shrink-0" />
                    <span><T en="Free professional advice">Asesoría inicial 100% gratuita</T></span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-emerald-500 shrink-0" />
                    <span><T en="No commitment required">Sin compromisos ni costes ocultos</T></span>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-2 w-full">
                  ...
                  <p className="text-xs text-[var(--color-text-secondary)] leading-relaxed">
                    <T en="We craft fully customized interfaces and code with state-of-the-art web technologies for elite results.">
                      Creamos interfaces totalmente personalizadas y programamos con tecnología web moderna, dándote acceso a vistas del avance en vivo.
                    </T>
                  </p>
                </div>
                ...
                <div className="w-full border-t border-[var(--color-border-subtle)]/40 pt-4 mt-1 space-y-2 text-left">
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    ...
                    <span><T en="Premium custom design concepts">Propuesta visual premium a tu medida</T></span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-[var(--color-primary-base)] shrink-0" />
                    <span><T en="Private styling updates">Ver el desarrollo activo paso a paso</T></span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-[var(--color-primary-base)] shrink-0" />
                    <span><T en="Continuous flexible reviews">Refinamiento constante y flexible</T></span>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-2 w-full">
                  ...
                  <p className="text-xs text-[var(--color-text-secondary)] leading-relaxed">
                    <T en="We launch your website meticulously configured for top performance, maximum speed, and ready to welcome users.">
                      Lanzamos tu sitio web minuciosamente configurado para el mayor rendimiento, velocidad máxima de carga y listo para recibir clientes.
                    </T>
                  </p>
                </div>
                ...
                <div className="w-full border-t border-[var(--color-border-subtle)]/40 pt-4 mt-1 space-y-2 text-left">
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-violet-400 shrink-0" />
                    <span><T en="Top-tier load speed optimizations">Velocidad máxima (PageSpeed 90+)</T></span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-violet-400 shrink-0" />
                    <span><T en="Standard technical structure configuration">Configuración técnica óptima de serie</T></span>
                  </div>
                  <div className="flex items-center gap-2.5 text-[11px] text-[var(--color-text-secondary)]">
                    <CheckCircle2 size={13} className="text-violet-400 shrink-0" />
                    <span><T en="Administrative access & full control">Acceso administrativo y control de tu web</T></span>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          >
            <div className="flex flex-col items-center text-center gap-6">
              ...
              <h2 className="text-4xl md:text-6xl font-display font-black tracking-tighter">
                <T en="Real projects, proven results">Proyectos reales, resultados demostrados</T>
              </h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="rounded-[var(--radius-bento)] p-6 sm:p-8 border border-[var(--color-border-subtle)] bg-[var(--color-surface-elevated)] backdrop-blur-md relative overflow-hidden bento-glow-hover">
              ...
              <div className="flex flex-col items-center mb-6 text-center max-w-xl mx-auto space-y-2">
                ...
                <p className="text-xs text-[var(--color-text-secondary)] leading-tight">
                  <T en="Continuous performance & premium user experiences built with standard tools. Tap to interact.">
                    Rendimiento impecable y experiencias interactivas optimizadas para conversión. Toca para probar.
                  </T>
                </p>
              </div>
              ...
              <div className="relative w-full overflow-hidden py-3">
                ...
                <div className="absolute left-0 top-0 h-full w-16 sm:w-24 bg-gradient-to-r from-[var(--color-surface-elevated)] to-transparent z-10 pointer-events-none" />
                <div className="absolute right-0 top-0 h-full w-16 sm:w-24 bg-gradient-to-l from-[var(--color-surface-elevated)] to-transparent z-10 pointer-events-none" />

                {/* Looping Track using High-Performance CSS Marquee */}
                <div className="animate-marquee flex gap-4 sm:gap-6 w-max whitespace-nowrap">
                  {(() => {
                    const baseTechs = [
                      { name: "Next.js", icon: Zap, color: "text-neutral-900 dark:text-white", accent: "text-amber-400", bg: "bg-amber-500/5 border-amber-500/10 hover:border-amber-500/30", glow: "shadow-[0_0_15px_rgba(245,158,11,0.15)]" },
                      { name: "React", icon: Code, color: "text-[#58c4dc]", accent: "text-sky-400", bg: "bg-sky-500/5 border-sky-500/10 hover:border-sky-500/30", glow: "shadow-[0_0_15px_rgba(14,165,233,0.15)]" },
                      { name: "Tailwind", icon: Globe, color: "text-[#38bdf8]", accent: "text-teal-400", bg: "bg-teal-500/5 border-teal-500/10 hover:border-teal-500/30", glow: "shadow-[0_0_15px_rgba(20,184,166,0.15)]" },
                      { name: "SEO Core", icon: BarChart3, color: "text-[#10b981]", accent: "text-emerald-400", bg: "bg-emerald-500/5 border-emerald-500/10 hover:border-emerald-500/30", glow: "shadow-[0_0_15px_rgba(16,185,129,0.15)]" },
                      { name: "Framer", icon: Layers, color: "text-[#a855f7]", accent: "text-violet-400", bg: "bg-violet-500/5 border-violet-500/10 hover:border-violet-500/30", glow: "shadow-[0_0_15px_rgba(139,92,246,0.15)]" },
                    ];
                    // Duplicate 4 times to ensure seamless infinite looping on wider displays
                    const marqueeItems = [...baseTechs, ...baseTechs, ...baseTechs, ...baseTechs];
                    return marqueeItems.map((tech, idx) => {
                      ...
                      return (
                        <motion.div
                          ...
                          whileTap={{ scale: 0.95 }}
                          className={`flex items-center gap-3 px-4 py-2.5 rounded-xl border ${tech.bg} ${tech.glow} transition-colors cursor-pointer select-none group/tech shrink-0`}
                        >
                          {/* Auto-breathing icon glow for mobile lifelike expression */}
                          <motion.div
                            animate={{ opacity: [0.7, 1, 0.7], scale: [0.95, 1, 0.95] }}
                            transition={{ repeat: Infinity, duration: 2.5, ease: "easeInOut", delay: (idx % 5) * 0.15 }}
                            className={`${tech.color}`}
                          >
                            <IconComponent size={18} />
                          </motion.div>
                          <span className="font-bold text-xs tracking-tight text-[var(--color-text-primary)] group-hover/tech:text-white transition-colors duration-200">
                            {tech.name}
                          </span>
                        </motion.div>
                      );
          ...
          {/* FAQ Section */}
          <div id="faq" className="md:col-span-2 lg:col-span-3 py-20 space-y-12">
      ...
      <section className="py-24 px-6 md:px-12 bg-[var(--color-surface-base)] relative overflow-hidden border-t border-[var(--color-border-subtle)]">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-5xl font-display font-black tracking-tight max-w-2xl mx-auto">
            <T en="Let's build a digital experience that drives results.">Construyamos una experiencia digital que multiplique tus resultados.</T>
          </h2>
          <p className="text-[var(--color-text-secondary)] text-sm md:text-lg max-w-lg mx-auto leading-relaxed">
            <T en="Get a personalized quote in less than 24 hours. No obligation.">Cotiza tu proyecto hoy y recibe una propuesta a la medida en menos de 24 horas.</T>
          </p>
          <div className="pt-4">
            <button 
              onClick={() => navigate('/cotizar')}
