  ...
  const values = [
    {
      ...
      description: (
        <T en="Every line of code and every pixel has a defined purpose. We leave nothing to chance.">
          Cada línea de código y cada píxel tiene un propósito definido. No
    ...
    },
    {
      ...
      description: (
        <T en="We explore the latest technologies to deliver solutions that not only work today, but lead tomorrow.">
          Exploramos las últimas tecnologías para ofrecer soluciones que no solo
          funcionen hoy, sino que lideren mañana.
        </T>
      ),
      icon: Lightbulb,
    ...
    },
    {
      ...
      description: (
        <T en="We don't just build websites; we create business tools that generate real conversions.">
          No solo construimos sitios web; creamos herramientas de negocio que
  ...
  const team = [
    {
      ...
      initials: "CD",
      bio: (
        <T en="Developer and digital strategist. Expert in the Google ecosystem and with broad mastery of the modern tech stack to lead development, design, and operations.">
          Desarrollador y estratega digital. Experto en el ecosistema de Google
          y con un amplio dominio del stack tecnológico moderno para dirigir el
          desarrollo, diseño y operaciones.
        </T>
      ),
    },
  ];
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 md:px-10 py-12 md:py-20 relative z-10 space-y-32">
        ...
        <section className="flex flex-col items-center text-center gap-6">
          ...
          >
            <T
              en={
                <>
                  Engineering Digital <br /> with Purpose.
                </>
              }
            >
          ...
          >
            <T en="Our mission is to raise the digital standard for brands in Latin America through elite web solutions.">
              Nuestra misión es elevar el estándar digital de las marcas en
              Latinoamérica a través de soluciones web de élite.
            </T>
          </motion.p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-display font-black tracking-tight">
              <T en="Our Story">Nuestra Historia</T>
            </h2>
            <div className="space-y-4 text-[var(--color-text-secondary)] leading-relaxed">
              <p>
                <T en="Polaris Web Studio was born with a clear vision: to bridge the gap between aesthetic design and exceptional technical performance.">
                  Polaris Web Studio nació con una visión clara: cerrar la
                  brecha entre el diseño estético y el rendimiento técnico
                  excepcional.{" "}
                </T>
              </p>
              <p>
                <T en="What started as a deep passion for development and technology has consolidated into an independent studio serving ambitious brands across the region, from disruptive startups to established businesses.">
                  Lo que comenzó como una profunda pasión por el desarrollo y la
                  tecnología, se ha consolidado como un estudio independiente
                  que sirve a marcas ambiciosas en toda la región, desde
                  startups disruptivas hasta empresas establecidas.
                </T>
              </p>
              <p>
                <T en="The web is the most critical frontier for any modern business, and my unwavering obsession with precision allows me to deliver consistent results that push the boundaries of conventionality.">
                  La web es la frontera más importante para cualquier negocio
                  moderno, y mi inquebrantable obsesión por la precisión me
                  permite entregar resultados consistentes que desafían los
          ...
          >
            ...
            <div className="relative text-center space-y-4">
              <Globe
                size={80}
                strokeWidth={1.5}
                className="mx-auto text-[var(--color-primary-base)]"
              />
              <p className="font-bold uppercase tracking-widest text-[var(--color-text-tertiary)]">
                <T en="100% Virtual & Global Operation">
                  Operación 100% Virtual & Global
                </T>
              </p>
            </div>
          </motion.div>
        ...
        <section className="space-y-12">
          <div className="text-center space-y-4">
            <h2 className="text-3xl md:text-5xl font-display font-black tracking-tight">
              <T en="Values that Guide Us">Valores que nos Guían</T>
            </h2>
          </div>
        ...
        <section className="space-y-12">
          <div className="text-center space-y-4">
            <h2 className="text-3xl md:text-5xl font-display font-black tracking-tight">
              <T en="The Team">El Equipo</T>
            </h2>
            <p className="text-[var(--color-text-secondary)] max-w-xl mx-auto">
              <T en="A personalized approach where creativity and technique work in sync to materialize your vision.">
                Un enfoque personalizado donde la creatividad y la técnica
                trabajan en sincronía para materializar tu visión.
              </T>
            </p>
          </div>
            ...
            {team.map((member, i) => (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-[var(--color-primary-base)] font-black uppercase tracking-[0.2em]">
                    {member.role}
                  </p>
        ...
        <section className="text-center space-y-10 pt-20">
          <h2 className="text-4xl md:text-7xl font-display font-black tracking-tighter max-w-4xl mx-auto">
