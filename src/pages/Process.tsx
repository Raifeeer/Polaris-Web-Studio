...
import { Search, Palette, Code, Rocket, ArrowRight, Check, Sparkles, Calculator, Calendar, X } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      shortDesc: <T en="Objectives alignment, target modeling, and technical planning.">Alineación estratégica, estudio de referentes y plano técnico.</T>,
      desc: <T en="We thoroughly analyze your business model, competitor ecosystem, and specify clear conversion goals (KPIs). At Polaris, we view digital presence as an applied science that bridges beautiful visual communication with measurable business performance.">Analizamos a fondo tu modelo de negocio, competencia de mercado y definimos metas de conversión claras (KPIs). En Polaris vemos la presencia digital como una ciencia aplicada que conecta comunicación visual con resultados de negocio.</T>,
      icon: Search,
      estTime: <T en="Week 1">Semana 1</T>,
      deliverables: [
        <T en="Interactive Sitemap Map">Mapa del sitio y flujos interactivos</T>,
        <T en="Market & Competitor Benchmarking">Análisis de mercado y competidores</T>,
        <T en="Tailor-made Technical Proposal">Definición de stack técnico y APIs</T>,
        <T en="Launch KPIs Definition Checklist">Especificación de objetivos y KPIs de éxito</T>
      ],
      kpi: <T en="Architecture and Scope Document Signed">Documento de arquitectura y alcance firmado</T>,
      polarismethod: <T en="Co-creative review with multi-industry benchmarks">Codiseño con benchmarks de múltiples industrias</T>
    },
    {
      id: "02",
      title: <T en="Architecture and Design">Arquitectura y Diseño</T>,
      shortDesc: <T en="Figma Interactive prototyping & visual system construction.">Prototipo interactivo en Figma y guías de estilo premium.</T>,
      desc: <T en="We craft polished, responsive, and high-impact digital user interfaces (UI/UX). Every visual layer, layout margin, typography selection, and motion sequence is built around maximize your brand value and user conversion rates.">Creamos interfaces de usuario pulidas, interactivas y adaptativas (UI/UX). Cada diseño, espaciado, selección tipográfica y animación está pensado para maximizar el valor de tu marca y las tasas de conversión.</T>,
      icon: Palette,
      estTime: <T en="Weeks 2 - 3">Semanas 2 - 3</T>,
      deliverables: [
        <T en="High-Fidelity Interactive Figma Prototype">Prototipo interactivo de alta fidelidad en Figma</T>,
        <T en="Visual Brand Book & Assets Toolkit">Kit de diseño, tipografías y componentes</T>,
        <T en="Multi-device Layout Breakpoint Approval">Garantía de rendimiento responsive (móvil y tablet)</T>,
        <T en="Custom CSS Style Token Setup">Definición de micro-interacciones y transiciones</T>
      ],
      kpi: <T en="Figma UX/UI Prototype 100% Approved">Prototipo de interfaz UI/UX aprobado al 100%</T>,
      polarismethod: <T en="Figma prototype testing simulating real client inputs">Diseño centrado en el usuario con datos reales de tu negocio</T>
    },
    {
      id: "03",
      title: <T en="Elite Development">Desarrollo de Élite</T>,
      shortDesc: <T en="TypeScript component execution, performance tuning.">Programación interactiva en React y optimización extrema de carga.</T>,
      desc: <T en="We transform visual architectures into lightweight, accessible, and fast React component code. Leveraging typing safety via TypeScript and optimized static assets, we ensure your platform maintains fluid frame rates and robust responsiveness.">Transformamos los diseños aprobados en código React y TypeScript ultraliguro, accesible y seguro. Implementamos una arquitectura limpia con optimización SEO extrema que garantiza cargas inmediatas.</T>,
      icon: Code,
      estTime: <T en="Weeks 4 - 5">Semanas 4 - 5</T>,
      deliverables: [
        <T en="Clean, Typesafe React Component Construction">Código React con tipado estricto en TypeScript</T>,
        <T en="Responsive Grid Layout & Media Optimization">Maquetación responsive adaptativa de alta velocidad</T>,
        <T en="Fluid Motion Layout Transition Engines">Inclusión de micro-animaciones fluidas con motion</T>,
        <T en="Secure Headless Forms & Third-Party APIs Connect">Integración de base de datos, CRM y pasarelas</T>
      ],
      kpi: <T en="Mobile & Desktop PageSpeed score above 95+">Puntuación de velocidad del sitio superior a 95+</T>,
      polarismethod: <T en="Strict semantic tagging & manual code review checks">Revisión exhaustiva y empaquetado libre de dependencias pesadas</T>
    },
    {
      id: "04",
      title: <T en="Launch & Support">Lanzamiento y Acompañamiento</T>,
      shortDesc: <T en="Technical auditing, DNS mapping, and ongoing maintenance.">Pruebas de estrés, despliegue global y soporte priorizado.</T>,
      desc: <T en="We deploy your custom solution to secure, global CDN-powered cloud hosting. We then submit sitemaps, verify SSL cert status, index directories, and trigger automated health watchdogs to ensure stable uptime and conversion readiness from second one.">Desplegamos tu sitio de forma segura mediante redes de entrega global de datos (CDN). Nos encargamos de la indexación SEO, certificados SSL automatizados, monitoreo de servidor y abrimos tu periodo de soporte exclusivo.</T>,
      icon: Rocket,
      estTime: <T en="Week 6">Semana 6</T>,
      deliverables: [
        <T en="Complete Host Setup & Wildcard SSL Integration">Puesta en producción del servidor y certificado SSL</T>,
        <T en="Frictionless DNS Mapping & CDN Optimization">Asignación final de dominio e indexación SEO</T>,
        <T en="Cross-device stress testing checking iframe sandboxes">Pruebas exhaustivas de carga y usabilidad responsive</T>,
        <T en="90 Days Polaris Premium Post-launch Support kickoff">Kickoff de Garantía Extendida de 90 días prioritarios</T>
      ],
      kpi: <T en="Site live with clean production telemetry logs">Sitio web en línea con métricas verificadas y cero errores</T>,
      polarismethod: <T en="24-hour uptime validation & automatic error alarm systems">Monitoreo automatizado con alertas inmediatas</T>
    }
  ];
      ...
      <main className="max-w-6xl mx-auto w-full px-6 md:px-10 py-16 md:py-24 relative z-10">
        ...
        <section className="text-center space-y-6 mb-16 md:mb-20">
          ...
          <p className="text-[var(--color-text-secondary)] text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            <T en="A systematic and transparent process designed to scale your brand with software reliability and world-class design standards.">Un proceso claro y sistemático diseñado para escalar tu marca y convertir visitantes en clientes de manera predecible.</T>
          </p>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col gap-3 md:gap-4 order-2 lg:order-1">
              <span className="text-[10px] font-mono font-black text-[var(--color-text-tertiary)] uppercase tracking-widest pl-1">
                <T en="Select step to audit deliverables:">Selecciona un paso para ver detalles:</T>
              </span>
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center shrink-0 transition-all duration-300 ${
                      ...
                      <Icon size={20} className={isSelected ? 'animate-pulse' : ''} />
                    </div>

                    <div className="flex-1 min-w-0 space-y-0.5">
                      <div className="flex items-center justify-between gap-2">
                        <span className={`text-[9px] font-mono font-black tracking-wider uppercase ${
                          isSelected ? 'text-[var(--color-primary-base)]' : 'text-[var(--color-text-tertiary)]'
                        }`}>
                  ...
                  <div className="py-6 space-y-5 relative z-10 flex-1">
                    ...
                    <div className="space-y-3 pt-2">
                      <span className="text-[10px] font-mono font-black text-[var(--color-text-tertiary)] uppercase tracking-wider block">
                        <T en="Key Deliverables Check">Entregables verificados de la fase:</T>
                      </span>
                  ...
                  <div className="pt-6 border-t border-[var(--color-border-subtle)]/50 mt-4 relative z-10 grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <span className="text-[9px] font-mono font-black text-[var(--color-text-tertiary)] uppercase tracking-widest block mb-1">
                        <T en="Quality Success Milestone">Hito de calidad y éxito</T>
                      </span>
        ...
        <section className="mt-28 md:mt-32 space-y-10">
           <div className="text-center space-y-4">
             <span className="inline-block text-emerald-500 text-[10px] font-mono font-black uppercase tracking-wider bg-emerald-500/10 px-3.5 py-1.5 rounded-full border border-emerald-500/20">
               <T en="Interactive & Direct Options">Opciones de contacto a medida</T>
             </span>
             <h2 className="text-3xl md:text-6xl font-display font-black tracking-tighter text-[var(--color-text-primary)]">
               <T en="Ready to elevate your digital presence?">¿Listo para elevar tu presencia digital?</T>
             </h2>
             <p className="text-[var(--color-text-secondary)] max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
               <T en="Choose how you prefer to start. Build your own live estimate step-by-step or skip straight to booking an alignment video call with our team.">Selecciona cómo prefieres empezar. Elige diseñar tu presupuesto paso a paso o agenda directamente una videoconferencia de alineación.</T>
             </p>
           </div>
             ...
             <div className="p-8 rounded-[var(--radius-bento)] border border-[var(--color-border-subtle)] bg-[var(--color-surface-elevated)] hover:border-[var(--color-primary-base)]/50 transition-all duration-300 relative overflow-hidden group flex flex-col justify-between min-h-[280px] shadow-lg bento-glow">
               ...
               <div className="relative z-10 space-y-4">
                 ...
                 <h3 className="text-xl md:text-2xl font-display font-black text-[var(--color-text-primary)]">
                   <T en="1. Build Custom Quote">1. Diseñar Presupuesto</T>
                 </h3>
                 <p className="text-sm text-[var(--color-text-secondary)] leading-relaxed">
                   <T en="Configure project type, scale, complexity, and custom AI integrations. Receive a tailored, detailed price estimation dynamically.">
                     Define el tipo de proyecto, alcance de pantallas, integraciones y obtén una estimación de inversión automatizada al instante.
                   </T>
                 </p>
               </div>
               <div className="pt-6 relative z-10">
                 ...
                 >
                   <T en="Go to Quote Wizard">Ir al Cotizador</T>
                   <ArrowRight size={14} />
                 </button>
               </div>
             </div>
               ...
               <div className="relative z-10 space-y-4">
                 ...
                 <p className="text-sm text-[var(--color-text-secondary)] leading-relaxed">
                   <T en="Book a direct 15-minute Google Meet in our calendar now. Have a face-to-face strategical talk regarding goals and deadlines.">
                     Agenda directamente una videollamada de 15 minutos en nuestro calendario. Define metas, fechas de entrega y aclara dudas cara a cara.
                   </T>
                 </p>
               </div>
               <div className="pt-6 relative z-10">
                 <button 
                   type="button"
                   onClick={() => { setIsSchedulerOpen(true); setIsSuccess(false); }}
                 ...
                 >
                   <T en="Book Live Consultation">Agendar Consultoría Gratuita</T>
                   <ArrowRight size={14} />
                 </button>
               </div>
             </div>
             ...
             <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
               ...
               >
                   ...
                   <div className="flex items-center gap-2.5">
                     ...
                     <div>
                       <h3 className="text-sm font-display font-black text-[var(--color-text-primary)]">
                         <T en="Strategic Consultation">Consultoría Estratégica</T>
                       </h3>
                       <p className="text-[10px] text-[var(--color-text-tertiary)] font-medium">
                         <T en="Direct video-call with Polaris team via Google Meet">Videollamada directa vía Google Meet con el equipo de Polaris</T>
                       </p>
                     </div>
                   </div>
                     ...
                     >
                       ...
                       <p className="text-sm text-[var(--color-text-secondary)] max-w-md mx-auto leading-relaxed">
                         <T en="We have successfully registered your session. A Google Meet invitation link has been dispatched to your email address. See you soon!">
                           Hemos registrado tu sesión de forma exitosa. Se ha enviado una invitación interactiva con el enlace de Google Meet a tu correo. ¡Nos vemos pronto!
                         </T>
                       </p>
                       <button 
                         onClick={() => setIsSchedulerOpen(false)} 
                 ...
                 <div className="px-6 py-3 border-t border-[var(--color-border-subtle)] bg-[var(--color-surface-elevated)] flex justify-between items-center text-[10px] text-[var(--color-text-tertiary)]">
                   <span>
                     <T en="* Direct video meeting length: 15 mins.">* Duración aproximada de la reunión: 15 minutos.</T>
                   </span>
                   <span>
