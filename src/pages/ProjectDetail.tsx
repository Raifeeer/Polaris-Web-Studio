...
export default function ProjectDetail() {
  ...
  if (!project) {
    return (
      <div className="min-h-[100svh] flex items-center justify-center bg-[var(--color-surface-base)]">
  ...
  return (
    <div className="min-h-[100svh] flex flex-col bg-[var(--color-surface-base)]">
      <Navbar />
