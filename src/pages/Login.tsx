      ...
      <div className="flex-1 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="text-center mb-8 space-y-2">
            <h1 className="text-2xl font-display font-black"><T en="Client Portal">Portal de Clientes</T></h1>
            <p className="text-[var(--color-text-secondary)] text-sm"><T en="Log in to track your project progress.">Ingresa para ver el progreso de tu proyecto.</T></p>
          </div>

          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-4">
               <div className="relative">
                 <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-[var(--color-text-tertiary)]" size={18} />
                 <input 
                   type="email"
                   required
                   value={email}
               ...
               <div className="relative">
                 <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-[var(--color-text-tertiary)]" size={18} />
                 <input 
                   type="password"
                   required
                   value={password}
            ...
            >
              {loading ? <T en="Authenticating...">Autenticando...</T> : <><T en="Access Portal">Acceder al Portal</T> <ArrowRight size={18} /></>}
            </button>
          </form>

          <p className="text-center text-xs text-[var(--color-text-tertiary)] mt-8">
            <T en="Did you forget your password? Contact your assigned manager.">¿Olvidaste tu contraseña? Contacta a tu project manager asignado.</T>
          </p>
        </motion.div>
      </div>
    </div>
