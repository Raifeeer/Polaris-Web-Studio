    ...
    <div className="min-h-screen flex flex-col bg-[var(--color-surface-base)] relative overflow-hidden">
      ...
      <main className="max-w-7xl mx-auto w-full px-6 md:px-10 py-16 md:py-24 relative z-10">
        ...
        <section className="text-center space-y-6 mb-20">
          <span className="text-[var(--color-primary-base)] text-xs font-black uppercase tracking-[0.2em]">Conceptos y Prototipos</span>
          <h1 className="text-5xl md:text-8xl font-display font-black tracking-tighter">Portafolio</h1>
          <p className="text-[var(--color-text-secondary)] text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Explora una selección de conceptos, interfaces y prototipos funcionales creados para demostrar el alcance de mi ingeniería y diseño visual.
          </p>
        </section>
              ...
              <div className="relative z-10 flex justify-between items-start">
                <div className="space-y-1">
                  <span className={`text-[10px] font-black uppercase tracking-[0.2em] ${
                    ...
                    'text-purple-500'
                  }`}>Plan {project.plan}</span>
                  <p className="text-[var(--color-text-tertiary)] text-[10px] font-black uppercase tracking-widest">{project.type}</p>
                </div>
        ...
        <section className="mt-32 text-center space-y-10">
           <h2 className="text-4xl md:text-7xl font-display font-black tracking-tighter">¿Tu proyecto es el siguiente?</h2>
           <button 
